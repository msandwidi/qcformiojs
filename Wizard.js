  ...
  _createClass(Wizard, [{
    ...
    value: function setPage(num) {
      ...
      if (!this.wizard.full && num >= 0 && num < this.pages.length) {
        ...
        return _nativePromiseOnly.default.resolve().then(function () {
          ...
          _this9.checkData(_this9.submission.data);
        });
    ...
    value: function setComponentSchema() {
      ...
      this.component.components.map(function (item) {
        ...
        _this13.originalComponents.push(_lodash.default.clone(item));
      });
    ...
    value: function focusOnComponent(key) {
      ...
      if (page && page !== this.currentPage) {
        return this.setPage(pageIndex).then(function () {
          _this14.checkValidity(_this14.submission.data, true, _this14.submission.data);

          _this14.showErrors();

          _get(_getPrototypeOf(Wizard.prototype), "focusOnComponent", _this14).call(_this14, key);
        });
      }
    ...
    get: function get() {
      ...
      [{
        ...
        if (_this15.hasButton(button.name)) {
